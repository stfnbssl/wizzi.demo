...
postcss.plugin = function plugin(name, initializer) {
  if (console && console.warn) {
    ...
    if (({"NODE_ENV":"development","SERVER_URL":"http://localhost:5000","API_SERVER_URL":"http://localhost:5000","PACKI_SEGMENT_KEY":"","PACKI_AMPLITUDE_KEY":"","PACKI_WEBPLAYER_URL":"","IMPORT_SERVER_URL":"http://localhost:5000","DEPLOY_ENVIRONMENT":"staging","BUILD_TIMESTAMP":1624008269099}).LANG && ({"NODE_ENV":"development","SERVER_URL":"http://localhost:5000","API_SERVER_URL":"http://localhost:5000","PACKI_SEGMENT_KEY":"","PACKI_AMPLITUDE_KEY":"","PACKI_WEBPLAYER_URL":"","IMPORT_SERVER_URL":"http://localhost:5000","DEPLOY_ENVIRONMENT":"staging","BUILD_TIMESTAMP":1624008269099}).LANG.startsWith('cn')) {
      // istanbul ignore next
      console.warn(
        name +
...
//# sourceMappingURL=vendors-node_modules_escape-html_index_js-node_modules_marked_lib_marked_js-node_modules_pris-17ca71.559f31a1aeb666a9a7a5.chunk.js.map