...
function getPageMetadata(props) {
  ...
  const url = `${({"NODE_ENV":"development","SERVER_URL":"http://localhost:5000","API_SERVER_URL":"http://localhost:5000","PACKI_SEGMENT_KEY":"","PACKI_AMPLITUDE_KEY":"","PACKI_WEBPLAYER_URL":"","IMPORT_SERVER_URL":"http://localhost:5000","DEPLOY_ENVIRONMENT":"staging","BUILD_TIMESTAMP":1624003156762}).PACKI_SERVER_URL}${props.id ? `/${props.id}` : ''}
    `;
  ...
  _createClass(PublishManager, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, children({
        ...
        packiUrl: id ? `${({"NODE_ENV":"development","SERVER_URL":"http://localhost:5000","API_SERVER_URL":"http://localhost:5000","PACKI_SEGMENT_KEY":"","PACKI_AMPLITUDE_KEY":"","PACKI_WEBPLAYER_URL":"","IMPORT_SERVER_URL":"http://localhost:5000","DEPLOY_ENVIRONMENT":"staging","BUILD_TIMESTAMP":1624003156762}).PACKI_SERVER_URL}/${id}` : undefined,
...
//# sourceMappingURL=EditorView.58b21b3bedcff255b40d.chunk.js.map