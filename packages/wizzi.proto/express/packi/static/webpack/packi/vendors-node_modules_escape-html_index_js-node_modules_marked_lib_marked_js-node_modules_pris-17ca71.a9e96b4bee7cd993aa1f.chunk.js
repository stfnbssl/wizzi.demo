...
postcss.plugin = function plugin(name, initializer) {
  if (console && console.warn) {
    ...
    if (({"NODE_ENV":"development","SERVER_URL":"http://localhost:5000","API_SERVER_URL":"http://localhost:5000","PACKI_SEGMENT_KEY":"","PACKI_AMPLITUDE_KEY":"","PACKI_WEBPLAYER_URL":"","IMPORT_SERVER_URL":"http://localhost:5000","DEPLOY_ENVIRONMENT":"staging","BUILD_TIMESTAMP":1624017311045}).LANG && ({"NODE_ENV":"development","SERVER_URL":"http://localhost:5000","API_SERVER_URL":"http://localhost:5000","PACKI_SEGMENT_KEY":"","PACKI_AMPLITUDE_KEY":"","PACKI_WEBPLAYER_URL":"","IMPORT_SERVER_URL":"http://localhost:5000","DEPLOY_ENVIRONMENT":"staging","BUILD_TIMESTAMP":1624017311045}).LANG.startsWith('cn')) {
      // istanbul ignore next
      console.warn(
        name +
...
//# sourceMappingURL=vendors-node_modules_escape-html_index_js-node_modules_marked_lib_marked_js-node_modules_pris-17ca71.a9e96b4bee7cd993aa1f.chunk.js.map