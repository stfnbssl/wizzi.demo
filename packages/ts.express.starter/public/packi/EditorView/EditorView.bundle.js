...
function getPageMetadata(props) {
  ...
  const url = "".concat(({"NODE_ENV":"development","SERVER_URL":"http://localhost:5100","API_SERVER_URL":"http://localhost:5100","PACKI_SEGMENT_KEY":"","PACKI_AMPLITUDE_KEY":"","PACKI_WEBPLAYER_URL":"","DEPLOY_ENVIRONMENT":"staging","BUILD_TIMESTAMP":1688114374286}).PACKI_SERVER_URL).concat(props.id ? "/".concat(props.id) : '', "\n    ");
