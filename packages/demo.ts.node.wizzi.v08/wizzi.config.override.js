/*
    ...
    primary source IttfDocument: C:/My/wizzi/stfnbssl/wizzi.cli/packages/wizzi.cli.meta/meta-templates/__temp/ts-node/demo.wizzi.v08/wizzi.config.override.js.ittf
*/
'use strict';
const path = require('path');
module.exports = {
    wfjobName: "demo.ts.node.wizzi.v08-override/job", 
