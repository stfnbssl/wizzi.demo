/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.demo\packages\wizzi.demo.server\.wizzi\src\features\wizzi\productions.ts.ittf
*/
...
export async function wizzifyV08(files: packiTypes.PackiFiles):  Promise<packiTypes.PackiFiles> {
    ...
    return new Promise(async (resolve, reject) => {
            ...
            for (const k of Object.keys(files)) {
                var extension = path.extname(k);
                try {
                    const ittfResult = await handleWizzifyV08(jsonwf, extension, files[k].contents);
                    result[k + '.ittf'] = {
                        type: 'CODE', 
                        contents: ittfResult
                     };
...
function handleWizzifyV08(jsonwf: any, extension: string, codeSnippet: string):  Promise<string> {
...
export async function getCodeASTV08(files: packiTypes.PackiFiles):  Promise<packiTypes.PackiFiles> {
    ...
    return new Promise(async (resolve, reject) => {
            ...
            for (const k of Object.keys(files)) {
                var extension = path.extname(k);
                try {
                    const astResult = await handleGetCodeASTV08(jsonwf, extension, files[k].contents);
                    result[k + '.ast'] = {
                        type: 'CODE', 
                        contents: stringify(astResult, null, 2)
                     };
...
function handleGetCodeASTV08(jsonwf: any, extension: string, codeSnippet: string):  Promise<any> {
