/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.demo\packages\wizzi.demo.server\.wizzi\Tests\utils\fetchApi.ts.ittf
*/
...
function putRequest_example() {
    ...
    putRequest(url, data).then(response => 
        ...
        console.log('Dati aggiornati:', updatedData, __filename);
    }
    ).catch((error) => {
