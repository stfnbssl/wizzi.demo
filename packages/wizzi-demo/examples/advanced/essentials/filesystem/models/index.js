/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-demo\.wizzi\examples\advanced\essentials\filesystem\models\index.js.ittf
*/
'use strict';
...
var artifactContext = {};
var globalContext = {};
var wizzimodels = function(step_callback) {
    ...
    async.series(samples, function(err, notUsed) {
        ...
        var msg = 'wizzimodels - samples - done.';
        console.log(msg);
        if (step_callback) {
...
wizzimodels.__name = 'Level 0 - wizzimodels';
function heading1(text) {
    console.log('');
    console.log('*'.repeat(120));
    console.log('** level 0 - step 1 - wizzimodels - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
