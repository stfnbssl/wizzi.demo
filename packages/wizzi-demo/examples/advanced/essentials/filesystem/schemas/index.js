/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-demo\.wizzi\examples\advanced\essentials\filesystem\schemas\index.js.ittf
*/
'use strict';
...
var artifactContext = {};
var globalContext = {};
var wizzischemas = function(step_callback) {
    ...
    async.series(samples, function(err, notUsed) {
        ...
        var msg = 'wizzischemas - samples - done.';
        console.log(msg);
        if (step_callback) {
...
wizzischemas.__name = 'Level 0 - wizzischemas';
function heading1(text) {
    console.log('');
    console.log('*'.repeat(120));
    console.log('** level 0 - step 1 - wizzischemas - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
