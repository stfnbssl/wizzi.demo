/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-demo\.wizzi\examples\starter\essentials\quick\level_0\step_1_go.js.ittf
*/
'use strict';
...
module.exports = function exec(step_callback) {
    ...
    heading1('starting step 1 quick.js.ittf')
    wizzi.gen(path.join(__dirname, 'step_1', 'quick.js.ittf'), {}, {
        globalContext: {}, 
        artifactContext: {}, 
        ...
        var dest = path.join(__dirname, 'step_1', 'outputs', verify.stripExtension('quick.js.ittf'));
        wizzi.file.write(dest, artifactText)
        console.log(verify.stripExtension('quick.js.ittf') + ' saved to ' + dest);
