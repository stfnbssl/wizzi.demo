/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-demo\.wizzi\examples\starter\essentials\models\index.js.ittf
*/
'use strict';
...
function heading1(text) {
    ...
    console.log('** level 0 - step 1 - wizzi models - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
...
module.exports = function exec(step_callback) {
    ...
    async.series(samples, function(err, notUsed) {
        ...
        var msg = 'wizzi models - samples - done.';
        console.log(msg);
        if (step_callback) {
