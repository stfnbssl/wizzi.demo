/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-demo\.wizzi\examples\starter\essentials\languageschemas\vue\level_0\step_3_go.js.ittf
*/
'use strict';
...
function heading1(text) {
    ...
    console.log('** level 0 - step 3 - language_schema_vue - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
function heading2(text) {
    ...
    console.log('   ','-- language_schema_vue - ' + text);
    console.log('   ', '-'.repeat(100));
    console.log('');
}
...
module.exports = function exec(step_callback) {
    ...
    heading1('starting step 3 preprocessed.ts.vue.ittf')
    wizzi.gen(path.join(__dirname, 'step_3', 'preprocessed.ts.vue.ittf'), {}, {
        globalContext: {}, 
        artifactContext: {}, 
        artifactName: 'vue/document'
        ...
        var dest = path.join(__dirname, 'step_3', 'outputs', verify.stripExtension('preprocessed.ts.vue.ittf'));
        wizzi.file.write(dest, artifactText)
        console.log(verify.stripExtension('preprocessed.ts.vue.ittf') + ' saved to ' + dest);
