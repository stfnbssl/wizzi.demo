/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-demo\.wizzi\examples\starter\essentials\languageschemas\vue\index.js.ittf
*/
'use strict';
...
function heading1(text) {
    ...
    console.log('** level 0 - step 1 - vue.languageschema - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
function heading2(text) {
    ...
    console.log('   ','-- vue.languageschema - ' + text);
    console.log('   ', '-'.repeat(100));
    console.log('');
}
...
module.exports = function exec(step_callback) {
    ...
    async.series(samples, function(err, notUsed) {
        ...
        var msg = 'vue.languageschema - samples - done.';
        console.log(msg);
        if (step_callback) {
