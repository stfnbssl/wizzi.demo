/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-demo\.wizzi\examples\starter\essentials\languageschemas\ts\level_0\step_3_go.js.ittf
*/
'use strict';
...
function heading1(text) {
    ...
    console.log('** level 0 - step 3 - language_schema_ts - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
...
module.exports = function exec(step_callback) {
    ...
    heading1('starting step 3 react_1.ts.ittf')
    wizzi.gen(path.join(__dirname, 'step_3', 'react_1.ts.ittf'), {}, {
        globalContext: {}, 
        artifactContext: {}, 
        ...
        var dest = path.join(__dirname, 'step_3', 'outputs', verify.stripExtension('react_1.ts.ittf'));
        wizzi.file.write(dest, artifactText)
        console.log(verify.stripExtension('react_1.ts.ittf') + ' saved to ' + dest);
