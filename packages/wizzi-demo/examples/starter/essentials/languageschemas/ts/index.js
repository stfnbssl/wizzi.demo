/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-demo\.wizzi\examples\starter\essentials\languageschemas\ts\index.js.ittf
*/
'use strict';
...
function heading1(text) {
    ...
    console.log('** level 0 - step 1 - ts.languageschema - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
function heading2(text) {
    ...
    console.log('   ','-- ts.languageschema - ' + text);
    console.log('   ', '-'.repeat(100));
    console.log('');
}
...
module.exports = function exec(step_callback) {
    ...
    async.series(samples, function(err, notUsed) {
        ...
        var msg = 'ts.languageschema - samples - done.';
        console.log(msg);
        if (step_callback) {
