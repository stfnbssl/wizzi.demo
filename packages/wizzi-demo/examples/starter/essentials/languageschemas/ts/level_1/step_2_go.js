/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-demo\.wizzi\examples\starter\essentials\languageschemas\ts\level_1\step_2_go.js.ittf
*/
'use strict';
...
function heading1(text) {
    ...
    console.log('** level 1 - step 2 - language_schema_ts - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
...
module.exports = function exec(step_callback) {
    ...
    heading1('starting step 2 react_1.ts.ittf')
    wizzi.gen(path.join(__dirname, 'step_2', 'react_1.ts.ittf'), {}, {
        globalContext: {}, 
        artifactContext: {}, 
        ...
        var dest = path.join(__dirname, 'step_2', 'outputs', verify.stripExtension('react_1.ts.ittf'));
