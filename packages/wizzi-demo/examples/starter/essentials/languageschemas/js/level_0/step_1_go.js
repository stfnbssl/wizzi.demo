/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-demo\.wizzi\examples\starter\essentials\languageschemas\js\level_0\step_1_go.js.ittf
*/
'use strict';
...
function heading1(text) {
    ...
    console.log('** level 0 - step 1 - language_schema_js - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
...
module.exports = function exec(step_callback) {
    ...
    heading1('starting step 1 basic.js.ittf')
    wizzi.gen(path.join(__dirname, 'step_1', 'basic.js.ittf'), {}, {
        globalContext: {}, 
        artifactContext: {}, 
        ...
        var dest = path.join(__dirname, 'step_1', 'outputs', verify.stripExtension('basic.js.ittf'));
        wizzi.file.write(dest, artifactText)
        console.log(verify.stripExtension('basic.js.ittf') + ' saved to ' + dest);
