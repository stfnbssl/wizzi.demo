/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-demo\.wizzi\examples\starter\essentials\languageschemas\js\level_0\step_4_go.js.ittf
*/
'use strict';
...
function heading1(text) {
    ...
    console.log('** level 0 - step 4 - language_schema_js - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
...
module.exports = function exec(step_callback) {
    ...
    heading1('starting step 4 module_1.js.ittf')
    wizzi.gen(path.join(__dirname, 'step_4', 'module_1.js.ittf'), {}, {
        globalContext: {}, 
        artifactContext: {}, 
        ...
        var dest = path.join(__dirname, 'step_4', 'outputs', verify.stripExtension('module_1.js.ittf'));
