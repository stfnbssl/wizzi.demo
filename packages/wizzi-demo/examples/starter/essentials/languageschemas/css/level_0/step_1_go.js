/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-demo\.wizzi\examples\starter\essentials\languageschemas\css\level_0\step_1_go.js.ittf
*/
'use strict';
...
function heading1(text) {
    ...
    console.log('** level 0 - step 1 - language_schema_css - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
...
module.exports = function exec(step_callback) {
    ...
    heading1('starting step 1 basic.css.ittf')
    wizzi.gen(path.join(__dirname, 'step_1', 'basic.css.ittf'), {}, {
        globalContext: {}, 
        artifactContext: {}, 
        ...
        var dest = path.join(__dirname, 'step_1', 'outputs', verify.stripExtension('basic.css.ittf'));
        wizzi.file.write(dest, artifactText)
        console.log(verify.stripExtension('basic.css.ittf') + ' saved to ' + dest);
        printValue('artifactText', artifactText)
        heading1('starting step 1 basic.html.ittf')
        wizzi.gen(path.join(__dirname, 'step_1', 'basic.html.ittf'), {}, {
            globalContext: {}, 
            artifactContext: {}, 
            ...
            // Save the artifact
            // to the ./outputs folder
            var dest = path.join(__dirname, 'step_1', 'outputs', verify.stripExtension('basic.html.ittf'));
            wizzi.file.write(dest, artifactText)
            console.log(verify.stripExtension('basic.html.ittf') + ' saved to ' + dest);
            printValue('artifactText', artifactText)
            step_callback(null);
        })
    })
