/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-demo\.wizzi\examples\starter\essentials\mtrees\index.js.ittf
*/
'use strict';
...
function heading1(text) {
    ...
    console.log('** level 0 - step 1 - mtrees - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
...
module.exports = function exec(step_callback) {
    ...
    wizzi.mtree(htmlFriendsPath, {
        ...
        level0(function(err, notUsed) {
            if (err) {
                throw new Error(JSON.stringify(err, null, 2));
            }
            return step_callback(null, 'mtrees example executed');
        })
    })
}
;
