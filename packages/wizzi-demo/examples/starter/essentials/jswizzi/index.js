/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-demo\.wizzi\examples\starter\essentials\jswizzi\index.js.ittf
*/
'use strict';
...
function heading1(text) {
    ...
    console.log('** level 0 - step 1 - jswizzi - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
...
module.exports = function exec(step_callback) {
    ...
    var sourcePath = path.join(__dirname, 'ittf', 'level_0', 'step_1', 'sample.html.ittf');
    heading1('sample.html.ittf')
    // Load a magical tree from an ittf document and a context object.
    wizzi.mtree(sourcePath, {}, function(err, mTreeModel) {
        if (err) {
            throw new Error(JSON.stringify(err, null, 2));
        }
        printValue('sample.html.ittf - mTree', mTreeModel.toIttf(), 'dashes')
        return step_callback(null, 'jswizzi example executed');
    })
}
;
